      ...
      <div className="flex flex-col gap-1.5">
        {label && (
          <label
            ...
            className={cn(
              'text-sm font-medium',
              onGlass ? 'text-[var(--input-glass-label)]' : 'text-text-secondary',
            )}
          >
            {label}
          </label>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              onGlass
                ? 'input-glass'
                : 'bg-bg-secondary border-border text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20',
